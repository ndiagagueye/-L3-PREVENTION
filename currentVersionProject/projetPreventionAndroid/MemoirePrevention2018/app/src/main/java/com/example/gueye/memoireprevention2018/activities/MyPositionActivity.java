                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        if (!TextUtils.isEmpty( address )){
                                            ...
                                            if(isLocationFound && userId != null) {
                                                ...
                                                locationMap.put("user_id", userId);

                                                mFirestore.collection("Users").document(userId).collection("Positions").document(userId).set(locationMap).addOnSuccessListener( new OnSuccessListener<Void>() {
                                                    @Override
                                            ...
                                            Toast.makeText( MyPositionActivity.this, "Veuillez précisez votre adresse.", Toast.LENGTH_SHORT ).show();
                                        }
