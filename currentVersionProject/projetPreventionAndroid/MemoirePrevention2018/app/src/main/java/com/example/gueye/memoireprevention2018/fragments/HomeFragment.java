...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        loading_spinner = view.findViewById(R.id.material_design_linear_scale_progress_loader);
            ...
            firstQuery.addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
                ...
                public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                    ...
                    if (!documentSnapshots.isEmpty()) {
                        ...
                        Toast.makeText(container.getContext() , "Not post", Toast.LENGTH_SHORT ).show();
                        hideLineScaleLoader();
                    }
    ...
    private  void lineScaleLoader() {
        loading_spinner.setVisibility(View.VISIBLE);
    }
    private void hideLineScaleLoader() {
